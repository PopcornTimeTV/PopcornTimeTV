...
extension ShowsViewController:UISearchBarDelegate,PCTPlayerViewControllerDelegate,UIViewControllerTransitioningDelegate{
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        //create the pseudo structures we need to conform to the rest of the torrents of the app
