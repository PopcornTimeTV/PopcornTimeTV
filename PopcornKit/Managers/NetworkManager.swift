...
public struct Popcorn {
    ...
    static let userAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0.1 Safari/605.1.14"
    static let defaultHeaders = ["User-Agent": Popcorn.userAgent]
}
